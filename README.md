...
Clone:
```sh
  git clone https://github.com/Mar12358/JavaScriptCapstone
```
...
Feel free to check the [issues page](https://github.com/Mar12358/JavaScriptCapstone/issues).
